...
namespace Referee.Infrastructure.SettingsFd
{
	public static class Constants
	{
		...
		public static readonly Settings DefaultSettings = new Settings(OptionalColumns, "ATLETIKA STARÁ BOLESLAV, z.s.", "", DateTime.Today, DateTime.Today, "Houštka, Stará Boleslav");
